(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["objj-parser"] = {}, global.fs, global.path));
  ...
  function parse(input, options) {
    ...
    if (process.argv[2] === "print-ast") {
      ...
      fs__namespace.writeFileSync(path__namespace.join(__dirname, "new-output"), JSON.stringify(tmp, replacer, 2));
    }
    return tmp
  }
...
//# sourceMappingURL=objj-parser.js.map
